import 'package:class_ix/pages/english.dart';
import 'package:class_ix/pages/nepali.dart';
import 'package:class_ix/pages/social.dart';
import 'package:class_ix/screens/drawer.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    final Uri toTelegram =
        Uri(scheme: 'https', host: 't.me', path: 'class9shikxak');
    final Uri moreNote = Uri(scheme: 'https', host: 'nexucorner.com', path: '');
    return Scaffold(
      appBar: AppBar(
        title: const Text('Class-9 Notes'),
        elevation: 0,
      ),
      drawer: MyDrawer(
